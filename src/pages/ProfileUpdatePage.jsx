...
const ProfileUpdatePage = () => {
  ...
  return (
    <div className="container minHeight">
      ...
      <form onSubmit={handleUpdate} className="p-4 border rounded mb-3">
        <div className="row">
          ...
          <div className="col-12 col-sm-6 col-md-4 mt-2 d-flex justify-content-center justify-content-sm-end align-items-center">
            <button
              type="submit"
